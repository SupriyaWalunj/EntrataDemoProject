...
public class WebsitePages {
    ...
    private GenericFunctionality genericFunctionality;

    public WebsitePages(WebDriver driver) {
        this.driver = driver;
        this.genericFunctionality = new GenericFunctionality(driver); // Instantiate GenericFunctionality
    }
    ...
    public void ValidateFooterLinks() {
        ...
        // Call the ValidateLink method from GenericFunctionality
        boolean result = genericFunctionality.ValidateLink(footerLinksLocator);
        if (result) {
    ...
    public void WindowHandling() {
        ...
        WebElement summitLink = driver.findElement(By.xpath("//a[@class='nav-link last dropdown-menu-text---brix w-nav-link']"));
